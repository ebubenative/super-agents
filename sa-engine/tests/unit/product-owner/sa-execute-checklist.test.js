...
import { SaExecuteChecklistTool } from '../../../mcp-server/tools/product-owner/sa-execute-checklist.js';
import { MockTaskManager } from '../../helpers/test-utils.js';
import { mockToolData } from '../../fixtures/mock-data.js';

describe('SaExecuteChecklistTool', () => {
  let tool;
  let mockTaskManager;

  beforeEach(() => {
    mockTaskManager = new MockTaskManager();
    tool = new SaExecuteChecklistTool(mockTaskManager);
  });
  ...
  describe('constructor', () => {
    it('should initialize with task manager', () => {
      ...
      expect(tool.name).toBe('sa-execute-checklist');
    });
  });
  ...
  describe('validate method', () => {
    ...
    it('should pass validation with valid parameters', async () => {
      const validParams = mockToolData.product-owner.sa_execute_checklist.validParams;
  ...
  describe('execute method', () => {
    ...
    it('should handle errors gracefully', async () => {
      const invalidParams = mockToolData.product-owner.sa_execute_checklist.invalidParams;
  ...
  describe('error handling', () => {
    it('should handle network errors', async () => {
      ...
      const result = await tool.execute(mockToolData.product-owner.sa_execute_checklist.validParams);
