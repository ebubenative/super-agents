...
import { SaAnalyzeComplexityTool } from '../../../mcp-server/tools/task-master/sa-analyze-complexity.js';
import { MockTaskManager } from '../../helpers/test-utils.js';
import { mockToolData } from '../../fixtures/mock-data.js';

describe('SaAnalyzeComplexityTool', () => {
  let tool;
  let mockTaskManager;

  beforeEach(() => {
    mockTaskManager = new MockTaskManager();
    tool = new SaAnalyzeComplexityTool(mockTaskManager);
  });
  ...
  describe('constructor', () => {
    it('should initialize with task manager', () => {
      ...
      expect(tool.name).toBe('sa-analyze-complexity');
    });
  });
  ...
  describe('validate method', () => {
    ...
    it('should pass validation with valid parameters', async () => {
      const validParams = mockToolData.task-master.sa_analyze_complexity.validParams;
  ...
  describe('execute method', () => {
    ...
    it('should handle errors gracefully', async () => {
      const invalidParams = mockToolData.task-master.sa_analyze_complexity.invalidParams;
  ...
  describe('error handling', () => {
    it('should handle network errors', async () => {
      ...
      const result = await tool.execute(mockToolData.task-master.sa_analyze_complexity.validParams);
