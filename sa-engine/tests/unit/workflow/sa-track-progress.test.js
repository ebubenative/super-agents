...
import { SaTrackProgressTool } from '../../../mcp-server/tools/workflow/sa-track-progress.js';
...
describe('SaTrackProgressTool', () => {
  ...
  describe('validate method', () => {
    ...
    it('should pass validation with valid parameters', async () => {
      const validParams = mockToolData.workflow.sa_track_progress.validParams;
  ...
  describe('execute method', () => {
    ...
    it('should handle errors gracefully', async () => {
      const invalidParams = mockToolData.workflow.sa_track_progress.invalidParams;
  ...
  describe('error handling', () => {
    it('should handle network errors', async () => {
      ...
      const result = await tool.execute(mockToolData.workflow.sa_track_progress.validParams);
