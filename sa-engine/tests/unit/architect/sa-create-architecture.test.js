...
import { SaCreateArchitectureTool } from '../../../mcp-server/tools/architect/sa-create-architecture.js';
import { MockTaskManager } from '../../helpers/test-utils.js';
import { mockToolData } from '../../fixtures/mock-data.js';

describe('SaCreateArchitectureTool', () => {
  let tool;
  let mockTaskManager;

  beforeEach(() => {
    mockTaskManager = new MockTaskManager();
    tool = new SaCreateArchitectureTool(mockTaskManager);
  });
  ...
  describe('constructor', () => {
    it('should initialize with task manager', () => {
      ...
      expect(tool.name).toBe('sa-create-architecture');
    });
  });
  ...
  describe('validate method', () => {
    ...
    it('should pass validation with valid parameters', async () => {
      const validParams = mockToolData.architect.sa_create_architecture.validParams;
  ...
  describe('execute method', () => {
    ...
    it('should handle errors gracefully', async () => {
      const invalidParams = mockToolData.architect.sa_create_architecture.invalidParams;
  ...
  describe('error handling', () => {
    it('should handle network errors', async () => {
      ...
      const result = await tool.execute(mockToolData.architect.sa_create_architecture.validParams);
