...
import { SaDebugIssueTool } from '../../../mcp-server/tools/developer/sa-debug-issue.js';
import { MockTaskManager } from '../../helpers/test-utils.js';
import { mockToolData } from '../../fixtures/mock-data.js';

describe('SaDebugIssueTool', () => {
  let tool;
  let mockTaskManager;

  beforeEach(() => {
    mockTaskManager = new MockTaskManager();
    tool = new SaDebugIssueTool(mockTaskManager);
  });
  ...
  describe('constructor', () => {
    it('should initialize with task manager', () => {
      ...
      expect(tool.name).toBe('sa-debug-issue');
    });
  });
  ...
  describe('validate method', () => {
    ...
    it('should pass validation with valid parameters', async () => {
      const validParams = mockToolData.developer.sa_debug_issue.validParams;
  ...
  describe('execute method', () => {
    ...
    it('should handle errors gracefully', async () => {
      const invalidParams = mockToolData.developer.sa_debug_issue.invalidParams;
  ...
  describe('error handling', () => {
    it('should handle network errors', async () => {
      ...
      const result = await tool.execute(mockToolData.developer.sa_debug_issue.validParams);
