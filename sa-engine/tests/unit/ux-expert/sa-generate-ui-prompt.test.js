...
import { SaGenerateUiPromptTool } from '../../../mcp-server/tools/ux-expert/sa-generate-ui-prompt.js';
import { MockTaskManager } from '../../helpers/test-utils.js';
import { mockToolData } from '../../fixtures/mock-data.js';

describe('SaGenerateUiPromptTool', () => {
  let tool;
  let mockTaskManager;

  beforeEach(() => {
    mockTaskManager = new MockTaskManager();
    tool = new SaGenerateUiPromptTool(mockTaskManager);
  });
  ...
  describe('constructor', () => {
    it('should initialize with task manager', () => {
      ...
      expect(tool.name).toBe('sa-generate-ui-prompt');
    });
  });
  ...
  describe('validate method', () => {
    ...
    it('should pass validation with valid parameters', async () => {
      const validParams = mockToolData.ux-expert.sa_generate_ui_prompt.validParams;
  ...
  describe('execute method', () => {
    ...
    it('should handle errors gracefully', async () => {
      const invalidParams = mockToolData.ux-expert.sa_generate_ui_prompt.invalidParams;
  ...
  describe('error handling', () => {
    it('should handle network errors', async () => {
      ...
      const result = await tool.execute(mockToolData.ux-expert.sa_generate_ui_prompt.validParams);
